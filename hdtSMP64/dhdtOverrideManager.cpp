...
bool hdt::Override::OverrideManager::registerOverride(UInt32 actor_formID, std::string old_file_path,
	...
	try {
		while (!data_stream.eof()) {
			...
			for (int i = 0; i < override_size; ++i) {
				...
				hdt::papyrus::impl::SwapPhysicsFileImpl(actor_formID, orig_physics_file, override_physics_file, true,
														false);
			}
		}
	}
