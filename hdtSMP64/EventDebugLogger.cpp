...
namespace hdt
{
	...
	{
		_DMESSAGE("Received ArmorAttachEvent(armorModel=%s (%016llX), skeleton=%s (%016llX), attachedNode=%s "
				  "(%016llX), hasAttached=%s).",
				  e.armorModel ? e.armorModel->m_name : "null", (uintptr_t)e.armorModel,
				  e.skeleton ? e.skeleton->m_name : "null", (uintptr_t)e.skeleton,
				  e.attachedNode ? e.attachedNode->m_name : "null", (uintptr_t)e.attachedNode,
